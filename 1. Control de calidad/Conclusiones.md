...
# 3. Sequence Counts
Todas las muestras tienen más o menos el mismo número de lecturas, aprox. 1300 lecturas por FASTQ. Esto es importante porque evita sesgos debidos a diferencias grandes de secuenciación entre muestras.
